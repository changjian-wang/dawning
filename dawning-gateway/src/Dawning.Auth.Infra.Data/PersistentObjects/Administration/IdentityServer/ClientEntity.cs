...
using Dawning.Auth.Domain.Entities;
using Dawning.Auth.Domain.Entities.IdentityServer;
using IdentityServer4.Models;

namespace Dawning.Auth.Infra.Data.PersistentObjects.Administration.IdentityServer
{
    /// <summary>
    /// Client
    /// </summary>
    ...
    public class ClientEntity
    {
        ...
        /// </summary>
        [Computed]
        public ICollection<object> Claims { get; set; }
        ...
        /// </summary>
        [Computed]
        public ICollection<ClientProperty> Properties { get; set; }
