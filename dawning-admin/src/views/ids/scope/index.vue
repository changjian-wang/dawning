      ...
      <a-row style="margin-bottom: 16px">
        <a-col :span="24">
          <a-form :model="searchForm" layout="inline">
            ...
            <a-form-item field="displayName" :label="$t('ids.scope.displayName')">
              <a-input
      ...
      >
        ...
        <template #showInDiscoveryDocument="{ record }">
          <a-tag :color="record.showInDiscoveryDocument ? 'green' : 'gray'">
            {{ record.showInDiscoveryDocument ? $t('common.yes') : $t('common.no') }}
          </a-tag>
        </template>
    ...
    >
      <a-form :model="formData" :rules="formRules" ref="formRef" layout="vertical">
        <a-row :gutter="16">
          ...
          <a-col :span="12">
            <a-form-item field="displayName" :label="$t('ids.scope.displayName')" required>
              <a-input
        ...
        <a-row :gutter="16">
          <a-col :span="8">
            <a-form-item field="emphasize" :label="$t('ids.scope.emphasize')">
              ...
              <div class="form-help-text">{{ $t('ids.scope.emphasize.help') }}</div>
            </a-form-item>
          </a-col>
          <a-col :span="8">
            <a-form-item field="required" :label="$t('ids.scope.required')">
              <a-switch v-model="formData.required" :disabled="isView" />
              <div class="form-help-text">{{ $t('ids.scope.required.help') }}</div>
            </a-form-item>
          </a-col>
          <a-col :span="8">
            <a-form-item field="showInDiscoveryDocument" :label="$t('ids.scope.showInDiscoveryDocument')">
              <a-switch v-model="formData.showInDiscoveryDocument" :disabled="isView" />
              <div class="form-help-text">{{ $t('ids.scope.showInDiscoveryDocument.help') }}</div>
            </a-form-item>
          </a-col>
        </a-row>

        <a-divider orientation="left">{{ $t('ids.scope.properties') }}</a-divider>
        <a-form-item>
          <a-space direction="vertical" fill>
            <a-space v-for="(value, key, index) in formData.properties" :key="index">
              <a-input
                :model-value="key"
            ...
            <a-button v-if="!isView" type="dashed" long @click="handleAddProperty">
              <template #icon><icon-plus /></template>
