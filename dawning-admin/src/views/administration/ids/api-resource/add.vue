<template>
  <div class="api-resource-add">
    <div class="container">
      <Breadcrumb :items="['认证授权', 'API资源', '新增信息']" />
      <a-form
        ref="formRef"
        class="form"
        layout="horizontal"
      ...
      <a-tabs :default-active-key="1" v-model:active-key="activeKey">
        <a-tab-pane key="1" tab="基本信息">
          ...
          <a-form-item label="资源路径" field="displayName">
            <a-input v-model:value="form.displayName" placeholder="请输入资源路径" />
          </a-form-item>
          <a-form-item label="资源描述" field="description">
            <a-input v-model:value="form.description" placeholder="请输入资源描述" />
          </a-form-item>
          <a-form-item label="允许访问令牌签名算法">
