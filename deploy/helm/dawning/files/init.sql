...
-- Generated at: 2025-12-30 13:56:10
-- 
...
INSERT IGNORE INTO `claim_types` (`id`, `name`, `display_name`, `type`, `description`, `required`, `non_editable`, `timestamp`, `created`) VALUES
...
INSERT IGNORE INTO `system_configs` (`id`, `name`, `key`, `value`, `description`, `non_editable`, `timestamp`, `created_at`) VALUES
...
INSERT IGNORE INTO `roles` (`id`, `name`, `display_name`, `description`, `is_system`, `is_active`, `permissions`, `created_at`) VALUES
...
INSERT IGNORE INTO permissions (id, code, name, description, resource, action, category, is_system, display_order) VALUES
...
INSERT IGNORE INTO gateway_clusters (cluster_id, name, description, destinations, load_balancing_policy, health_check_enabled, health_check_path, is_enabled)
VALUES 
...
INSERT IGNORE INTO gateway_routes (route_id, name, cluster_id, match_path, transform_path_remove_prefix, sort_order, is_enabled)
VALUES 
...
INSERT IGNORE INTO `rate_limit_policies` (`id`, `name`, `display_name`, `policy_type`, `permit_limit`, `window_seconds`, `description`) VALUES
...
INSERT IGNORE INTO `alert_rules` (`name`, `description`, `metric_type`, `operator`, `threshold`, `duration_seconds`, `severity`, `is_enabled`, `notify_channels`, `cooldown_minutes`) VALUES
...
INSERT IGNORE INTO system_configs (id, name, `key`, value, description, non_editable, timestamp, created_at)
...
INSERT IGNORE INTO `tenants` (`id`, `code`, `name`, `description`, `domain`, `is_active`, `plan`, `timestamp`, `created_at`)
VALUES (
...
INSERT IGNORE INTO `permissions` (`id`, `code`, `name`, `description`, `resource`, `action`, `category`, `is_system`, `display_order`)
VALUES 
