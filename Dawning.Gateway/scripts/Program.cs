...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        var sqlFilePath = @"C:\github\dawning\Dawning.Gateway\docs\sql\008_create_permissions_table.sql";
        ...
        try
        {
            ...
            {
                Console.WriteLine($"Executed: {args.StatementText.Substring(0, Math.Min(80, args.StatementText.Length)).Replace("\n", " ")}...");
            };
