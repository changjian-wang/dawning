...
namespace Dawning.Identity.Application.Interfaces.Administration
{
    ...
    public interface IPermissionService
    {
        ...
        Task<PagedData<PermissionDto>> GetPagedListAsync(PermissionModel model, int page, int pageSize);
        ...
        Task<bool> AssignPermissionsToRoleAsync(Guid roleId, IEnumerable<Guid> permissionIds, Guid? operatorId = null);
